...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css?family=Baloo+Bhaina+2|Baloo+Paaji+2|Maven+Pro|Nunito+Sans|Rajdhani&display=swap"
    rel="stylesheet">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="informacion center col-12">
        ...
        <a href="https://www.linkedin.com/in/juanmguzman/" class="sepiconos"><i
            class="fab fa-linkedin linkedin iconos"></i></a>
        <a href="https://github.com/juanmguzmann" class="sepiconos"><i class="fab fa-github iconos"></i></a>
        <a href="/storage/CV - Juan Marcos Guzman.pdf" class="sepiconos" download> <i
            class="far fa-file-pdf iconos"></i></a>
        <a href="mailto:juanmguzmann@gmail.com" target="_blank" class="sepiconos"><i
            class="iconos far fa-envelope"></i></a>
      </div>
    </div>
    ...
    <div class="formacion row">
      ...
      <div class="informacion center col col-md-6 col-lg-4">
        ...
        <p class="wow fadeInLeft">NodeJS</p>
        <p class="wow fadeInLeft">React JS</p>
        <p class="wow fadeInLeft">AWS</p>
      ...
      <div class="informacion center col col-md-12 col-lg-4">
        <ul class="">
          ...
          <li class="institucion">Just BrainIt | Nov 2020 - Actualidad</li>
          <br>
          <li>Access Administration Specialist</li>
